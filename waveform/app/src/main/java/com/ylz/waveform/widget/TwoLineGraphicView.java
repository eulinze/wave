...
public class TwoLineGraphicView extends View
{
	/**
	 * 公共部分
	 */
	...
	public TwoLineGraphicView(Context context)
	{
		this(context, null);
	}

	public TwoLineGraphicView(Context context, AttributeSet attrs)
	{
		super(context, attrs);
...
//		}
	...
	public void setData(ArrayList<Double> yRawData,ArrayList<Double> y1RawData,
