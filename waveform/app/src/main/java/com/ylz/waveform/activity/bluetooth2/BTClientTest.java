...
public class BTClientTest extends Activity {

	private final static int REQUEST_CONNECT_DEVICE = 1;    //宏定义查询设备句柄

	private final static String MY_UUID = "0000180D-0000-1000-8000-00805f9b34fb";   //SPP服务UUID号0000180D-0000-1000-8000-00805f9b34fb
	...
	private void startSocket(){
		...
		String address = getIntent().getStringExtra(EXTRAS_DEVICE_ADDRESS);
		// 得到蓝牙设备句柄
	...
	Thread readThread=new Thread(){
		...
		public void run(){
			...
			Log.e("testsssss",buffer.toString());
			int i = 0;
			int n = 0;
			bRun = true;
			//接收线程
