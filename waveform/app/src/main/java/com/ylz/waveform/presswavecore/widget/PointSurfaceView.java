...
import com.ylz.waveform.presswavecore.listener.UploadDataListener;
...
public class PointSurfaceView extends SurfaceView implements SurfaceHolder.Callback, UploadDataListener, ServerLineViewWrap.OnCompareLineListener, BlueService.BlueCallback {
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        //ToastUtils.toast(context,"surfaceCreated");
    ...
    public void surfaceChanged(SurfaceHolder holder, int format, int width, int height) {
        //ToastUtils.toast(context,"surfaceChanged");
    }

    @Override
    public void surfaceDestroyed(SurfaceHolder holder) {
        ToastUtils.toast(context,"surfaceDestroyed");
    }
