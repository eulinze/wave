...
import com.ylz.waveform.tools.BleSppGattAttributes;
...
public class BluetoothLeService extends Service {
        ...
        public void onServicesDiscovered(BluetoothGatt gatt, int status) {
            if (status == BluetoothGatt.GATT_SUCCESS) {
                ...
                if (service!=null)
                {
                    ...
                    mReadCharacteristic  = service.getCharacteristic(UUID.fromString(BleSppGattAttributes.BLE_SPP_Read_Characteristic));
                }
    ...
    public void writeCharacteristicGattDb( byte[] byteArray) {

        if (mBluetoothAdapter == null || mBluetoothGatt == null) {
            return;
        } else {
            byte[] valueByte = byteArray;
            mReadCharacteristic.setValue(valueByte);
            mBluetoothGatt.writeCharacteristic(mReadCharacteristic);
        }
    }
