package com.ylz.waveform.presswavecore.localService;
...
public class BlueService extends Service {
    ...
    private static final String ACTION_BLUETOOTH_POINT = "com.ylz.waveform.presswave.ACTION_BLUETOOTH_POINT";
